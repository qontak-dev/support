...
3. Klik button "**Add Qontak CRM Account**" untuk menyambungkan akun qontak CRM yang akan diintegrasikan.
   ...
   > **Notes** : Untuk tampilan integrasi pada CRM tidak akan muncul pada inbox karena yang masuk pada inbox hanya untuk pembuatan tiket ke CRM, contoh jika customer masuk ke inbox melalui salah satu channel yang ada, maka sistem akan otomatis membuat tiket pada CRM
